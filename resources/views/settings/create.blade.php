                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('mainurl') is-invalid @enderror"
                                       name="mainurl" value="{{ old('mainurl') }}">
                                @error('mainurl')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="mobilephone" value="{{ old('mobilephone') }}">
                                @error('mobilephone')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle1') is-invalid @enderror"
                                       name="ctitle1" value="{{ old('ctitle1') }}">
                                @error('ctitle1')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle1" value="{{ old('calttitle1') }}">
                                @error('calttitle1')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle2') is-invalid @enderror"
                                       name="ctitle2" value="{{ old('ctitle2') }}">
                                @error('ctitle2')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle2" value="{{ old('calttitle2') }}">
                                @error('calttitle2')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle3') is-invalid @enderror"
                                       name="ctitle3" value="{{ old('ctitle3') }}">
                                @error('ctitle3')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle3" value="{{ old('calttitle3') }}">
                                @error('calttitle3')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle4') is-invalid @enderror"
                                       name="ctitle4" value="{{ old('ctitle4') }}">
                                @error('ctitle4')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle4" value="{{ old('calttitle4') }}">
                                @error('calttitle4')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle5') is-invalid @enderror"
                                       name="ctitle5" value="{{ old('ctitle5') }}">
                                @error('ctitle5')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle5" value="{{ old('calttitle5') }}">
                                @error('calttitle5')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control @error('ctitle6') is-invalid @enderror"
                                       name="ctitle6" value="{{ old('ctitle6') }}">
                                @error('ctitle6')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="calttitle6" value="{{ old('calttitle6') }}">
                                @error('calttitle6')
                                <span class="invalid-feedback" role="alert">
