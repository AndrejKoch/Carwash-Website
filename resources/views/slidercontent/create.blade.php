...
@section('content')
    ...
    @endif
    <form action="{{ route('slidercontent.store') }}" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-primary">Create new content slider</button>
